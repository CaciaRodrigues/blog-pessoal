...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Bruna", "bruna@email.com", "13465278", "-"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService
				.cadastrarUsuario(new Usuario(0L, "Jualiana Andrade", "juliana_andrade@email.com.br", "12345678", "-"));

		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Juliana Andrade",
				"juliana_andrade@email.com.br", "12345678", "-");
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService
				.cadastrarUsuario(new Usuario(0L, "Sabrina Sanches", "sabrina_sanches@email.com", "sabrina123", "-"));
